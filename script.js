...
function render() {
  ...
  students.forEach((student) => {
    ...
    btn.addEventListener("click", () => edit(student));
...
function edit(student) {
  ...
  <label>
    Nom: <input type="text" name="nom" value=${student.nom} >
  </label>
  <label>
    Prenom: <input type="text" name="prenom" value=${student.prenom}>
  </label>
    <div>email: <input type="text" name="email" value=${student.email}></div>
    <label>telephone: <input type="text" name="telephone" value=${student.telephone}></label>
...
function save(e, student) {
  ...
  // let studentToUpdate = students.find((s) => s.id === student.id);
